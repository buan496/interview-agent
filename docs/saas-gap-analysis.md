...
- PR #33：Ability profile v1。基于历史训练继续扩展能力画像。
...
1. PR #33：扩展能力画像，为 Agent Memory 和个性化训练打基础。
2. PR #34：引入组织/租户模型，支撑企业级 SaaS。
3. PR #35：引入 Agent Memory v1。
...
- PR #33 应继续扩展能力画像，让历史数据进入更稳定的个性化训练基础。
